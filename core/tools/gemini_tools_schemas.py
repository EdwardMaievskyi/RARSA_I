...
@tool("wikipedia_search",
      args_schema=ctt.WikipediaSearchArgs,
      return_direct=True)
...
@tool("duckduckgo_search",
      args_schema=ctt.DuckDuckGoSearchArgs,
      return_direct=True)
...
@tool("scrape_and_summarize_web_page",
      args_schema=ctt.ScrapeArgs,
      return_direct=True)
...
@tool("tavily_search",
      args_schema=ctt.TavilySearchArgs,
      return_direct=True)
...
gemini_tools_schemas = [wikipedia_search,
                        duckduckgo_search,
